# This is an assessment project for junior frontend developer role given by Rayda with [Next.js](https://nextjs.org/), [`material ui`](https://mui.com/),[`redux toolkit query`](https://redux-toolkit.js.org/) used.
